    ...
    return(
        <React.Fragment>
            <div className="flex flex-col bg-black">
                <div className="justify-center items-center text-lg text-cyan-300 p-6 md:mr-40 md:ml-40 md:my-6">
                    ...
                    <span className=" text-purple-500 flex justify-center items-center text-2xl p-3 mb-5 font-serif">{"In Crypto We Trust, But In Uranus, We Believe!"}</span>
                    <div className="mb-4">
                        <h3 className="text-yellow-300">The Memeifesto</h3>
